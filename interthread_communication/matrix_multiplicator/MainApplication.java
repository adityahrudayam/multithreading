...
public class MainApplication {
        ...
        public void run() {
            while (true) {
                ...
                if (matricesPair == null) {
                    System.out.println("No more matrices.txt to read from the queue, consumer is terminating.");
                    break;
                }
        ...
        public void run() {
            while (true) {
                ...
                if (matrix1 == null || matrix2 == null) {
                    queue.terminate();
                    System.out.println("No more matrices.txt to read. Producer Thread is terminating.");
                    return;
                }
    ...
    private static class ThreadSafeQueue {
        private final Queue<MatricesPair> queue = new LinkedList<>(); // to hold our matrices.txt
        private boolean isEmpty = true; // to indicate whether the queue contains any matrices.txt or not
        private boolean isTerminate = false; // to signal the consumer that the producer doesn't have any more matrices.txt
        // and hence can terminate.
